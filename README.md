...
First, make sure you have all of the needed libraries installed.<br><br>
Then, run "main.py" and paste in the URL of the image or select one from your computer.
